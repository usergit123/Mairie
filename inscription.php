...
<html>
    ...
    <td>  <strong>Sexe : </td>
    <td>  <input type="radio" name="sexe" value="homme" > Homme<br></td>
    <td>  <input type="radio" name="sexe" value="femme"> Femme<br></td>
            
            <tr>
            
            <td><label for="fonction"><strong> Votre fonction :</strong></label></td>
    ...
    if(isset($_POST["register"])){
        ...
        elseif($_POST["pass"] == $_POST["pass2"]){
            ...
            if($_POST["login"] != $_POST["pass"]){
                ...
                $sql = "SELECT * FROM personne WHERE pseudo = '".$_POST["login"]."' ";
