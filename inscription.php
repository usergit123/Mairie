...
<html>
    ...
    <body>
        ...
        <form action="" method="post">
            ...
            <td><label for="Tel"><strong> Numéro de téléphone :</strong></label></td>
            ...
            <td><label for="Codepostal"><strong> Code postal :</strong></label></td>
            ...
            <td><label for="Datenaiss"><strong> Datenaiss :</strong></label></td>
    ...
    if(isset($_POST["register"])){
        ...
        elseif($_POST["pass"] == $_POST["pass2"]){
            ...
            if($_POST["login"] != $_POST["pass"]){
                ...
                $sql = "SELECT NomCompte FROM personne WHERE NomCompte = '".$_POST["login"]."' ";
                  ...
                  if(strlen($_POST["pass"] < 999999999999999999999999999999999)){
                     ...
                     if(strlen($_POST["login"] < 999999999999999999999999999)){
                        ...
                        if($_POST["login"] != $_POST["pass"]){
                           ...
                           $sql = "INSERT INTO personne (idP,Motdepasse,Nom,Prenom,Adresse,Tel,Codepostal,Email,Datenaiss) VALUES ('".$_POST["login"]."','".$_POST["pass"]."',
						   '".$_POST["nom"]."','".$_POST["prenom"]."''".$_POST["adresse"]."','".$_POST["tel"]."''".$_POST["C"]."',
						   '".$_POST["pass"]."''".$_POST["login"]."','".$_POST["pass"]."')";
                           $sql = mysqli_query($BDD,$sql);
